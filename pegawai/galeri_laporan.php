...
$subtitle = "Koleksi laporan publikasi BPS Bangkalan";

// Ambil daftar sub jenis khusus laporan (id_sub_jenis 18,19,20,21)
$subList = [];
$subQ = mysqli_query($koneksi, "SELECT id_sub_jenis, nama_sub_jenis FROM sub_jenis WHERE id_sub_jenis IN (18,19,20,21) ORDER BY nama_sub_jenis ASC");
if ($subQ) {
    ...
    <div class="header-left" style="display:flex;align-items:center;gap:16px;">
      <div class="header-text">
        ...
        <p style="margin:0;font-size:14px;color:#475569;">
          ...
          <?php else: ?>
            Pilih sub untuk menampilkan koleksi galeri laporan.
          <?php endif; ?>
  ...
  <div class="grid"> 
    ...
    <div class="card<?= $mediaDriveId || $driveEmbedId ? ' card-with-drive' : '' ?>" <?= $cardDataAttr ?> >
      ...
      <div class="body">
        ...
        <?php if ($mediaDriveId || $driveEmbedId): ?>
