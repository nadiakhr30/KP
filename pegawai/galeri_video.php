...
$breadcrumbTitle = "Galeri Video";
$subtitle = "Koleksi video publikasi BPS Bangkalan";

// Sub jenis khusus untuk video

// Ambil daftar sub jenis untuk id_jenis = 7 (Galeri Video)
$subList = [];
$subQ = mysqli_query($koneksi, "SELECT id_sub_jenis, nama_sub_jenis FROM sub_jenis WHERE id_jenis = 7 ORDER BY nama_sub_jenis ASC");
if ($subQ) {
...
// Tambahkan mapping Google Drive setelah $selectedSub sudah pasti
$driveFolderMap = [
  15 => '17ZJUa8nX_-G5HLYaLU-hrzxt1BjW3ebE',
  16 => '1iPPy7eJZOmRBJoBlhzHkJ_rLf3QJ0S2Y',
  17 => '1DPS7SXg0RKjgmcJ2orELz3-eEdW-TcUW'
];
...
<div class="page-wrapper">
  <div class="breadcrumb-custom">
    ...
    <span class="breadcrumb-separator">›</span>
    <span class="breadcrumb-separator">Galeri Video</span>
    <span class="breadcrumb-separator">›</span>
    ...
    <div class="header-left" style="display:flex;align-items:center;gap:16px;">
      <div class="header-text">
        ...
        <p style="margin:0;font-size:14px;color:#475569;">
          ...
          <?php else: ?>
            Pilih sub untuk menampilkan koleksi galeri video.
          <?php endif; ?>
