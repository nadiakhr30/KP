...
// Get all data
$qData = mysqli_query($koneksi, "SELECT * FROM halo_pst ORDER BY nama_halo_pst");
$dataList = [];
...
if ($format == 'print') {
    ...
    <head>
        ...
        <title>Laporan Data Halo PST</title>
    ...
    <body>
        ...
        <div class="header-info">
            <h2>Laporan Data Halo PST Sistem Kehumasan</h2>
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th style="width: 85%;">Nama Halo PST</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    <td><?= $index + 1 ?></td>
                    <td><?= $item['id_halo_pst'] ?></td>
                    <td><?= htmlspecialchars($item['nama_halo_pst']) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
...
// EXCEL FORMAT
    ...
    $sheet->setTitle('Data Halo PST');
    
    $sheet->getColumnDimension('A')->setWidth(5);
    $sheet->getColumnDimension('B')->setWidth(10);
    $sheet->getColumnDimension('C')->setWidth(30);

    $headers = ['No', 'ID', 'Nama Halo PST'];
    ...
    foreach ($dataList as $index => $item) {
        ...
        $sheet->setCellValue("B$row", $item['id_halo_pst']);
        $sheet->setCellValue("C$row", $item['nama_halo_pst']);
        $row++;
    }
    ...
    $filename = 'Laporan_Halo_PST_' . date('Y-m-d_H-i-s') . '.xlsx';
