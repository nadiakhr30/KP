...
$qData = mysqli_query($koneksi, "SELECT * FROM jenis_aset ORDER BY nama_jenis_aset");
$dataList = [];
...
if ($format == 'print') {
    ...
    <head>
        ...
        <title>Laporan Data Jenis Aset</title>
    ...
    <body>
        ...
        <div class="header-info">
            <h2>Laporan Data Jenis Aset Sistem Kehumasan</h2>
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th style="width: 85%;">Nama Jenis Aset</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    <td><?= $index + 1 ?></td>
                    <td><?= $item['id_jenis_aset'] ?></td>
                    <td><?= htmlspecialchars($item['nama_jenis_aset']) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
    ...
    $sheet->setTitle('Data Jenis Aset');
    
    $sheet->getColumnDimension('A')->setWidth(5);
    $sheet->getColumnDimension('B')->setWidth(10);
    $sheet->getColumnDimension('C')->setWidth(30);

    $headers = ['No', 'ID', 'Nama Jenis Aset'];
    ...
    foreach ($dataList as $index => $item) {
        ...
        $sheet->setCellValue("B$row", $item['id_jenis_aset']);
        $sheet->setCellValue("C$row", $item['nama_jenis_aset']);
        $row++;
    }
    ...
    $filename = 'Laporan_Jenis_Aset_' . date('Y-m-d_H-i-s') . '.xlsx';
