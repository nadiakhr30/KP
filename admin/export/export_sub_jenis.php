...
$qData = mysqli_query($koneksi, "SELECT s.*, j.nama_jenis FROM sub_jenis s LEFT JOIN jenis j ON s.id_jenis = j.id_jenis ORDER BY s.nama_sub_jenis");
$dataList = [];
...
if ($format == 'print') {
    ...
    <head>
        ...
        <title>Laporan Data Sub Jenis</title>
    ...
    <body>
        ...
        <div class="header-info">
            <h2>Laporan Data Sub Jenis Sistem Kehumasan</h2>
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th style="width: 40%;">Nama Sub Jenis</th>
            ...
            <tbody>
                ...
                <tr>
                    <td><?= $index + 1 ?></td>
                    <td><?= $item['id_sub_jenis'] ?></td>
                    <td><?= htmlspecialchars($item['nama_sub_jenis']) ?></td>
    ...
    $headers = ['No', 'ID', 'Nama Sub Jenis', 'Jenis'];
    ...
    foreach ($dataList as $index => $item) {
        ...
        $sheet->setCellValue("B$row", $item['id_sub_jenis']);
        $sheet->setCellValue("C$row", $item['nama_sub_jenis']);
    ...
    $filename = 'Laporan_Sub_Jenis_' . date('Y-m-d_H-i-s') . '.xlsx';
