...
$qData = mysqli_query($koneksi, "SELECT * FROM jabatan ORDER BY nama_jabatan");
$dataList = [];
...
if ($format == 'print') {
    ...
    <body>
        ...
        <div class="header-info">
            <h2>Laporan Data Jabatan Sistem Kehumasan</h2>
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th style="width: 85%;">Nama Jabatan</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= htmlspecialchars($item['nama_jabatan']) ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
    ...
    foreach ($dataList as $index => $item) {
        ...
        $sheet->setCellValue("B$row", $item['id_jabatan']);
    ...
    $filename = 'Laporan_Jabatan_' . date('Y-m-d_H-i-s') . '.xlsx';
