...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $nama_role = mysqli_real_escape_string($koneksi, trim($_POST['nama_role']));

    if (empty($nama_role)) {
        $error = "Nama Role wajib diisi!";
    } else {
        $updateQuery = "UPDATE role SET nama_role = '$nama_role' WHERE id_role = $id_role";
