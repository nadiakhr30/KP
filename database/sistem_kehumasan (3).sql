...
INSERT INTO `jadwal` (`id_jadwal`, `tim`, `topik`, `judul_kegiatan`, `tanggal_penugasan`, `tanggal_rilis`, `keterangan`, `status`, `dokumentasi`, `link_instagram`, `link_facebook`, `link_youtube`, `link_website`) VALUES
(1, 'PPID', 'Jumat Berkah', 'Acara Jumat Berkah Bulan Agustus', '2026-01-20', '2026-01-23', 'Kasih banyak MBG yah', 0, NULL, '-', NULL, '-', NULL),
(2, 'PPID', 'Jumat Berkah', 'Acara Jumat Berkah Bulan Agustus', '2026-01-21', '2026-01-21', 'aaaaaaaaaaaaaaaa', 0, NULL, '-', '-', NULL, NULL);
